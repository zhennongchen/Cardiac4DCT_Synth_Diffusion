...
import Diffusion_motion_field.denoising_diffusion_pytorch.denoising_diffusion_pytorch.diffusion_EDM as edm
...
#######################
trial_name = 'MVF_EDM_previous_code'
how_many_timeframes_together = 1

pre_trained_model = os.path.join('/mnt/camca_NAS/4DCT','models', trial_name, 'models/model-4000.pt')
start_step = 4000
slice_range = [0,96]
...
trainer = edm.Trainer(
    ...
    train_num_steps = 1000000000, # total training epochs
